...
public class NameUtils
{
   ...
   public static void checkNCName(String name, String type) throws IllegalArgumentException
   {
      if(!isNCName(name))
      {
   ...
   public static void checkQualifiedName(String name, String type) throws IllegalArgumentException
   {
   ...
   public static String buildQualifiedName(String prefix, String localName)
   {
   ...
   private static String charClass(String... patterns)
   {
      final StringBuilder result = new StringBuilder();
