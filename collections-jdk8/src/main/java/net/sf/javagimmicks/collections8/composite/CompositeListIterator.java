...
class CompositeListIterator<E> implements ListIterator<E>
{
   ...
   CompositeListIterator(final List<? extends ListIterator<E>> iterators)
   {
      _index = -1;
      _iterators = iterators.listIterator();
   }

   CompositeListIterator(final List<? extends List<E>> lists, int startIndex)
   {
      _index = startIndex - 1;
      ...
      for (final ListIterator<? extends List<E>> listsIterator = lists.listIterator(); listsIterator.hasNext();)
      {
