...
public class HsqlJpaTestRule extends AbstractJpaTestRule
{
    ...
    */
   public HsqlJpaTestRule(final EntityManagerFactoryConfigurator configurator,
         final File dbFolder,
    ...
    *            if the list of package names is empty
    */
   public HsqlJpaTestRule(final File dbFolder, final String... entityPackages)
   {
    ...
    *            if the list of package names is empty
    */
   public HsqlJpaTestRule(final String... entityPackages)
   {
   ...
   {
      return new HsqlDbTestRule(configurator, dbFolder);
   }
