 ...
 * 
 * <pre>
 * public class DerbyJpaTestRuleTest
 * {
 * 
 *    &#064;Rule
...
public class DerbyJpaTestRule extends AbstractJpaTestRule
{
    ...
    */
   public DerbyJpaTestRule(final EntityManagerFactoryConfigurator configurator,
         final File dbFolder,
    ...
    *            if the list of package names is empty
    */
   public DerbyJpaTestRule(final File dbFolder, final String... entityPackages)
   {
    ...
    *            if the list of package names is empty
    */
   public DerbyJpaTestRule(final String... entityPackages)
   {
   ...
   {
      return new DerbyDbTestRule(configurator, dbFolder);
   }
