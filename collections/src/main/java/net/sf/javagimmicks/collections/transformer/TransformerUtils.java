...
public class TransformerUtils
{
    ...
    */
   public static <KF, KT, VF, VT> Map<KT, VT> decorate(final Map<KF, VF> map, final Function<KF, KT> keyTransformer,
         final Function<VF, VT> valueTransformer)
   {
   ...
   public static <KF, KT, VF, VT> Map<KT, VT> decorate(final Map<KF, VF> map,
         final BidiFunction<KF, KT> keyTransformer, final Function<VF, VT> valueTransformer)
   {
      final Map<KF, VT> valueTransformingMap = decorateValueBased(map, valueTransformer);
      return decorateKeyBased(valueTransformingMap, keyTransformer);
   }
    ...
    */
   public static <KF, KT, VF, VT> Map<KT, VT> decorate(final Map<KF, VF> map, final Function<KF, KT> keyTransformer,
         final BidiFunction<VF, VT> valueTransformer)
   {
      final Map<KF, VT> valueTransformingMap = decorateValueBased(map, valueTransformer);
      return decorateKeyBased(valueTransformingMap, keyTransformer);
   }
    ...
    */
   public static <KF, KT, VF, VT> Map<KT, VT> decorate(final Map<KF, VF> map,
         final BidiFunction<KF, KT> keyTransformer, final BidiFunction<VF, VT> valueTransformer)
   {
      final Map<KF, VT> valueTransformingMap = decorateValueBased(map, valueTransformer);
      return decorateKeyBased(valueTransformingMap, keyTransformer);
   }
   ...
   public static <KF, KT, VF, VT> SortedMap<KT, VT> decorate(final SortedMap<KF, VF> map,
         final Function<KF, KT> keyTransformer, final Function<VF, VT> valueTransformer)
   {
    ...
    */
   public static <KF, KT, VF, VT> SortedMap<KT, VT> decorate(final SortedMap<KF, VF> map,
         final Function<KF, KT> keyTransformer, final BidiFunction<VF, VT> valueTransformer)
   {
      final SortedMap<KF, VT> valueTransformingMap = decorateValueBased(map, valueTransformer);
      return decorateKeyBased(valueTransformingMap, keyTransformer);
   }
